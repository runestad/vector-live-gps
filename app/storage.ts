...
export function migrateStoredData(rawV2: string | null, rawV1: string | null, demos: Scenario[]): StoredAppData {
  const defaults: AppSettings = { light: false, routeVisible: true, statusVisible: true, locked: false, interfaceProfile: "vector", saveProfileWithScenario: false, presenterLock: "triple-confirm", presenterZoomControls: false, presenterScale: false, presenterAttribution: true, presenterBranding: true, presenterClock: true, notificationSound: false };
  try {
    if (rawV2) {
